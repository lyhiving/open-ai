...
*A message from creator,<br />Thank you for visiting the __@lyhiving/open-ai__ repository! If you find this repository helpful or useful, we encourage you to **star** it
...
|------------------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| **lyhiving/open-ai** | **PHP 7.4+**         | [![Total Downloads](https://img.shields.io/packagist/dt/lyhiving/open-ai.svg?style=flat-square)](https://packagist.org/packages/lyhiving/open-ai) <br>              | **Most downloaded, forked, contributed, huge community supported, and used PHP SDK for OpenAI GPT-3 and DALL-E. It also supports chatGPT-like streaming.** | Community                   | Available, ([Community driven Discord Server](https://discord.gg/xpGUD528XJ) or personal mail [orhan@duck.com](mailto:orhan@duck.com)) |
...
- lyhiving/open-ai featured
  on [PHPStorm blog post](https://blog.jetbrains.com/phpstorm/2022/12/php-annotated-december-2022/#:~:text=lyhiving/open%2Dai%20%E2%80%93%20A%20PHP%20SDK%20for%20accessing%20the%20OpenAI%20GPT%2D3%20API),
  thanks JetBrains!
...
Thank you for considering a donation to lyhiving/OpenAI PHP SDK. Your support is greatly appreciated and helps to
...
Url of The ChatGPT-Clone Repo https://github.com/lyhiving/ChatGPT
...
> check [DALL·E Examples](https://github.com/lyhiving/DALLE-Examples)
...
Please report security vulnerabilities to [lyhiving@gmail.com](mailto:lyhiving@gmail.com)

## Credits

- [Orhan Erday](https://github.com/lyhiving)
